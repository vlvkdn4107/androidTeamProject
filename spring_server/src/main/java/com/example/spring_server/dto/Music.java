...
public class Music {
	...
	public static List<Music> sampledata() {
		...
		list.add(new Music(1, "싸이", "That That",
		...
		list.add(new Music(2, "(여자)아이들", "TOMBOY",
		...
		list.add(new Music(3, "IVE (아이브)", "LOVE DIVE",
		...
		list.add(new Music(4, "멜로망스", "사랑인가 봐",
		...
		list.add(new Music(5, "BIGBANG (빅뱅)", "봄여름가을겨울 (Still Life)",
		...
		list.add(new Music(6, "임영웅", "사랑은 늘 도망가",
		...
		list.add(new Music(7, "BIG Naughty (서동현)", "정이라고 하자 (Feat. 10CM)",
		...
		list.add(new Music(8, "임영웅", "우리들의 블루스",
		...
		list.add(new Music(9, "경서", "나의 X에게",
		...
		list.add(new Music(10, "LE SSERAFIM (르세라핌)", "FEARLESS",
		...
		list.add(new Music(12, "BE'O (비오)", "LOVE me",
		...
		list.add(new Music(14, "김민석 (멜로망스)", "취중고백",
		...
		list.add(new Music(15, "박재범", "GANADARA (Feat. 아이유)",
		...
		list.add(new Music(16, "임영웅", "이제 나만 믿어요",
		...
		list.add(new Music(20, "제시 (Jessi)", "ZOOM",
		...
		list.add(new Music(22, "경서예지, 전건호", "다정히 내 이름을 부르면",
		...
		list.add(new Music(23, "임영웅", "손이 참 곱던 그대",
				"https://cdnimg.melon.co.kr/cm2/album/images/109/23/444/10923444_20220502140600_500.jpg?5bd42dcc031a23cd1cae99ae37a606aa/melon/resize/282/quality/80/optimize",
				"끝없이 별빛이 내리던 밤\r\n" + "기분 좋은 바람이\r\n" + "두 빰을 스치고\r\n" + "새벽 바다 한곳을 보는\r\n" + "아름다운 너와 나\r\n"
						+ "그림을 그려갔어\r\n" + "모래 위 떨린 손끝으로\r\n" + "날 향해 웃어주는 입술\r\n" + "끝 모양과 저 달보다\r\n"
						+ "사랑스러운 두 눈을 가진 네가\r\n" + "다정히 내 이름을\r\n" + "부르면 내 마음이\r\n" + "녹아내려 언제나\r\n"
		...
		list.add(new Music(24, "태연 (TAEYEON)", "INVU",
		...
		list.add(new Music(25, "IVE (아이브)", "ELEVEN",
		...
		list.add(new Music(26, "임영웅", "A bientot",
				"https://cdnimg.melon.co.kr/cm2/album/images/109/23/444/10923444_20220502140600_500.jpg?5bd42dcc031a23cd1cae99ae37a606aa/melon/resize/282/quality/80/optimize",
				"A bientot\r\n" + "A bientot\r\n" + "이 밤이 지나면 괜찮아질 수 있을까\r\n" + "쓰린 내 맘이 회복될 수가 있을까\r\n"
						+ "네가 떠난 빈자리가 너무 크니까\r\n" + "그 공허함에 깔려 겨우 살고 있잖아\r\n" + "기억은 잔인하고 후유증은 지독해\r\n"
						+ "겨우 잠을 이뤄도 꿈자리는 뒤숭숭해\r\n" + "마음의 반을 도려내 버리고 난 후에\r\n" + "너라는 감옥에서 풀려날 수 있었네\r\n"
		...
		list.add(new Music(27, "임영웅", "사랑해 진짜",
		...
		list.add(new Music(28, "(여자)아이들", "MY BAG",
		...
		list.add(new Music(29, "임영웅", "사랑해 진짜",
				"https://cdnimg.melon.co.kr/cm2/album/images/109/23/444/10923444_20220502140600_500.jpg?5bd42dcc031a23cd1cae99ae37a606aa/melon/resize/282/quality/80/optimize",
				"숱한 날들 모두 내게 남아있는 추억들\r\n" + "빛바랜 기억들 사이\r\n" + "그대 모습만이 아련하게 빛나네\r\n" + "지나간 세월이 야속하진 않아\r\n"
						+ "그댈 만났으므로\r\n" + "피어날 내일을 기대해 오\r\n" + "그대 내게 와줬으니\r\n" + "나 진짜 진짜 당신만을 사랑하고 사랑해\r\n"
						+ "내 삶의 반쪽 그대만을\r\n" + "아 나는 그대만 보고 있어\r\n" + "아 나는 그대를 사랑합니다\r\n" + "오색빛의 색이 물든 미완성의 그림 하나\r\n"
		...
		list.add(new Music(30, "MSG워너비(M.O.M)", "듣고 싶을까",
				"https://cdnimg.melon.co.kr/cm2/album/images/108/80/544/10880544_20220225141002_500.jpg/melon/resize/120/quality/80/optimize",
		...
		list.add(new Music(31, "임영웅", "연애편지",
				"https://cdnimg.melon.co.kr/cm2/album/images/109/23/444/10923444_20220502140600_500.jpg/melon/resize/120/quality/80/optimize",
				"노을에 물든 저녁 하늘이\r\n" + "오랜만에 참 좋은 저녁입니다\r\n" + "문득 떠오른 그대 생각에\r\n" + "나지막이 이름을 불러봅니다\r\n"
						+ "나도 몰래 꺼내 본 낡은 수첩엔\r\n" + "그대가 너무도 많아\r\n" + "차마 그립단 말 대신\r\n" + "꽃잎을 넣어 보내며\r\n"
						+ "하얀 종이에 하지 못한 말\r\n" + "아직 그댄 내 고운 사랑입니다\r\n" + "외로이 스쳐 창을 흔드는\r\n" + "바람 소리 쓸쓸한 시간입니다\r\n"
		...
		list.add(new Music(32, "주호", "내가 아니라도",
		...
		list.add(new Music(33, "The Kid LAROI, Justin Bieber", "STAY",
		...
		list.add(new Music(34, "Charlie Puth", "That's Hilarious",
		...
		list.add(new Music(35, "케이시(Kassy)", "늦은 밤 헤어지긴 너무 아쉬워",
				"https://cdnimg.melon.co.kr/cm2/album/images/109/60/568/10960568_20220518153132_500.jpg/melon/resize/120/quality/80/optimize",
				"어쩌면 너도 나와 같은 꿈 꿀까\r\n" + "매일 마주 보며 눈뜨는 하루\r\n" + "늦은 밤 헤어지긴 너무 아쉬워\r\n" + "널 많이 사랑하나 봐\r\n"
						+ "유난히 날씨가 좋은 날\r\n" + "넌 나를 설레이게 해\r\n" + "영화 속에서만 보던 일들이\r\n" + "요즘 내 일상인 듯해\r\n"
						+ "어쩌면 너도 나와 같은 꿈 꿀까\r\n" + "매일 마주 보며 눈뜨는 하루\r\n" + "늦은 밤 헤어지긴 너무 아쉬워\r\n" + "널 많이 사랑하나 봐\r\n"
						+ "오늘 너에게 고백하겠어\r\n" + "취해서 하는 말이 아냐\r\n" + "참아온 진심인 거야\r\n" + "하루 종일 아무것도 안 해도\r\n"
		...
		list.add(new Music(36, "임영웅", "보금자리",
				"https://cdnimg.melon.co.kr/cm2/album/images/109/23/444/10923444_20220502140600_500.jpg?5bd42dcc031a23cd1cae99ae37a606aa/melon/resize/282/quality/80/optimize",
				"그대 사랑이 나였음 좋겠다\r\n" + "아무것도 필요 없어요\r\n" + "든든한 품에 안겨 잠들고 싶어라\r\n" + "내 사랑의 보금자리\r\n"
						+ "아무것도 바라지 않아요\r\n" + "당신만 있으면 돼\r\n" + "한 눈 팔지 않고 사랑할래요\r\n" + "돈도 필요 없어 백도 필요 없어\r\n"
						+ "당신만 있으면 돼\r\n" + "그대 사랑이 나였음 좋겠다\r\n" + "아무것도 필요 없어요\r\n" + "든든한 품에 안겨 잠들고 싶어라\r\n"
		...
		list.add(new Music(37, "임영웅", "사랑해요 그대를",
				"https://cdnimg.melon.co.kr/cm2/album/images/109/23/444/10923444_20220502140600_500.jpg?5bd42dcc031a23cd1cae99ae37a606aa/melon/resize/282/quality/80/optimize",
				"너무나 고마운 사람\r\n" + "너무나 따뜻한 사람\r\n" + "한 번도 잊어본 적 없는\r\n" + "내 마음속에 그 사람\r\n" + "나 그대 생각만 해도\r\n"
						+ "가슴이 뭉클해지고\r\n" + "그런 당신 내 곁에 있어\r\n" + "나는 행복한 사람\r\n" + "그대는 나만의 사랑\r\n" + "그대는 나만의 행복\r\n"
						+ "세월 가도 영원히\r\n" + "당신은 나만의 사랑\r\n" + "사랑해요 그대를\r\n" + "사랑해요 그대를\r\n" + "이 생명 다할 때까지\r\n"
		...
		list.add(new Music(38, "세븐틴", "Dar+ing",
				"https://cdnimg.melon.co.kr/cm2/album/images/109/22/231/10922231_20220527120653_500.jpg?d4668bd274949f814ae2ccadee6f42eb/melon/resize/282/quality/80/optimize",
		...
		list.add(new Music(39, "방탄소년단", "Dynamite",
		...
		list.add(new Music(40, "태연 (TAEYEON)", "Weekend",
		...
		list.add(new Music(42, "방탄소년단", "Butter",
		...
		list.add(new Music(43, "주시크 (Joosiq)", "너를 생각해",
		...
		list.add(new Music(44, "YENA (최예나)", "SMILEY (Feat. BIBI)",
		...
		list.add(new Music(45, "케이시 (Kassy)", "언제나 사랑해",
		...
		list.add(new Music(46, "성시경", "너의 모든 순간",
		...
		list.add(new Music(47, "주시크 (Joosiq)", "아무래도 난",
		...
		list.add(new Music(49, "볼빨간사춘기", "Seoul",
		...
		list.add(new Music(50, "방탄소년단", "봄날",
