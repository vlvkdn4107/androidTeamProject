package com.melontubeproject.dto;
...
public class Music {
	...
	list.add(new Music("싸이","That That","https://cdnimg.melon.co.kr/cm2/album/images/109/37/474/10937474_20220428225312_500.jpg/melon/resize/120/quality/80/optimize","20 22\r\n"
			...
			+ "That that I like that babe\r\n"
			+ "That that I like that"));
	list.add(new Music("TOMBOY","(여자)아이돌","https://cdnimg.melon.co.kr/cm2/album/images/108/90/384/10890384_20220314111504_500.jpg/melon/resize/120/quality/80/optimize","Look at you 넌 못 감당해 날\r\n"
			+ "Ya took off hook\r\n"
			+ "기분은 Coke like brrr\r\n"
	...
	list.add(new Music("LOVE DIVE","IVE (아이브)","https://cdnimg.melon.co.kr/cm2/album/images/109/09/179/10909179_20220405103521_500.jpg/melon/resize/120/quality/80/optimize","네가 참 궁금해 그건 너도 마찬가지\r\n"
			+ "이거면 충분해 쫓고 쫓는 이런 놀이\r\n"
			+ "참을 수 없는 이끌림과 호기심\r\n"
			+ "묘한 너와 나 두고 보면 알겠지\r\n"
			+ "\r\n"
			...
			+ "Woo oh perfect sacrifice yeah\r\n"
			+ "숨 참고 love dive"));
	list.add(new Music("사랑인가 봐","멜로망스","https://cdnimg.melon.co.kr/cm2/album/images/108/71/162/10871162_20220217162422_500.jpg/melon/resize/120/quality/80/optimize","너와 함께 하고 싶은 일들을\r\n"
			+ "상상하는 게\r\n"
			+ "요즘 내 일상이 되고\r\n"
			+ "너의 즐거워하는 모습을 보고 있으면\r\n"
			+ "자연스레 따라 웃고 있는 걸\r\n"
			...
			+ "우리 만나볼 만하잖아\r\n"
			+ "아무래도 사랑인가 봐"));
	list.add(new Music("봄여름가을겨울 (Still Life)","BIGBANG (빅뱅)","https://cdnimg.melon.co.kr/cm2/album/images/109/08/834/10908834_20220404174407_500.jpg/melon/resize/120/quality/80/optimize","이듬해 질 녘 꽃 피는 봄 한여름 밤의 꿈\r\n"
			...
			+ "아름다울 우리의 봄 여름 가을 겨울"));
	list.add(new Music("사랑은 늘 도망가","임영웅","https://cdnimg.melon.co.kr/cm2/album/images/107/35/654/10735654_20211008114339_500.jpg/melon/resize/120/quality/80/optimize","눈물이 난다 이 길을 걸으면\r\n"
			+ "그 사람 손길이 자꾸 생각이 난다\r\n"
			+ "붙잡지 못하고 가슴만 떨었지\r\n"
			+ "내 아름답던 사람아\r\n"
			+ "사랑이란 게 참 쓰린 거더라\r\n"
			...
			+ "잠시 쉬어가면 좋을 텐데\r\n"
			+ "잠시 쉬어가면 좋을 텐데"));
	list.add(new Music("정이라고 하자 (Feat. 10CM)","BIG Naughty (서동현)","https://cdnimg.melon.co.kr/cm2/album/images/109/25/762/10925762_20220419152007_500.jpg/melon/resize/120/quality/80/optimize","Back to the day\r\n"
			+ "갓 10대가 됐을 때\r\n"
			+ "그때 내가 널 보지 못했다면\r\n"
			+ "어땠을까 해\r\n"
			...
			+ "더듬고 있을 때면\r\n"
			+ "You say"));
	list.add(new Music("우리들의 블루스","임영웅","https://cdnimg.melon.co.kr/cm2/album/images/109/23/444/10923444_20220502140600_500.jpg/melon/resize/120/quality/80/optimize","잊지는 말아요 함께 했던 날들\r\n"
			+ "눈물이 날 때면\r\n"
			+ "그대 뒤를 돌아보면 돼요\r\n"
			+ "아프지 말아요 쓸쓸한 마음에\r\n"
			+ "힘든 일이 참 많았죠 그대에겐\r\n"
			...
			+ "어두운 길을 밝게 비추는\r\n"
			+ "그대의 빛이 될게요"));
	list.add(new Music("나의 X에게","경서","https://cdnimg.melon.co.kr/cm2/album/images/109/29/486/10929486_20220422151852_500.jpg/melon/resize/120/quality/80/optimize","우리 다시 만날래\r\n"
			+ "예쁘게 빛나던\r\n"
			+ "모든 추억들이\r\n"
			+ "너무 그리워\r\n"
			+ "너의 품에 안길래\r\n"
			...
			+ "벚꽃엔딩같이 듣고 있으면\r\n"
			+ "부러울 게 없었어"));
	list.add(new Music("FEARLESS","LE SSERAFLM (르세라핌)","https://cdnimg.melon.co.kr/cm2/album/images/109/39/458/10939458_20220502123814_500.jpg/melon/resize/120/quality/80/optimize","Bam ba ba ba ba bam ba ba ba ba bam\r\n"
			+ "Ba ba ba ba bam\r\n"
	...
	list.add(new Music("다시 만날 수 있을까","임영웅","https://cdnimg.melon.co.kr/cm2/album/images/109/23/444/10923444_20220502140600_500.jpg/melon/resize/120/quality/80/optimize","너를 위해 해 줄 것이 하나 없어서\r\n"
			+ "보낼 수밖에 없었고\r\n"
			+ "네가 없이 사는 법을 알지 못해서\r\n"
			+ "순간순간을 울었다\r\n"
			+ "후회로 가득한 한숨 자락이\r\n"
			...
			+ "시린 폭포처럼\r\n"
			+ "쏟아지는 날 그 언젠가"));
	list.add(new Music("LOVE me","BE'O (비오)","https://cdnimg.melon.co.kr/cm2/album/images/109/16/904/10916904_20220412101049_500.jpg/melon/resize/120/quality/80/optimize","Hey girl, Where you at? (Where you at?)\r\n"
			+ "대체 어디서 뭐 하는지 궁금해\r\n"
			...
			+ "울어버리고서 떼를 써야 할지"));
	list.add(new Music("Feel My Rhythm","Red Velvet (레드벨벳)","https://cdnimg.melon.co.kr/cm2/album/images/108/94/554/10894554_20220321100622_500.jpg/melon/resize/120/quality/80/optimize","Red Velvet\r\n"
			+ "\r\n"
			+ "무도회를 뒤집어\r\n"
			+ "작은 소란을 또 일으켜\r\n"
			...
			+ "이 순간을 놓지 마 Baby"));
	list.add(new Music("취중고백","김민석 (멜로망스)","https://cdnimg.melon.co.kr/cm2/album/images/108/16/959/10816959_20211217144957_500.jpg/melon/resize/120/quality/80/optimize","뭐하고 있었니 늦었지만\r\n"
			+ "잠시 나올래\r\n"
			+ "너의 집 골목에 있는\r\n"
			+ "놀이터에 앉아 있어\r\n"
			+ "친구들 만나서 오랜만에\r\n"
			...
			+ "귀찮게 안할게 혼자 아플게\r\n"
			+ "진심이야 너를 사랑하고 있어"));
	list.add(new Music("GANADARA (Feat. 아이유)","박재범","https://cdnimg.melon.co.kr/cm2/album/images/108/89/981/10889981_20220311110820_500.jpg/melon/resize/120/quality/80/optimize","길거리를 걷다 보면\r\n"
			+ "사랑 노래만 흘러나와\r\n"
			+ "나는 왜 저런 게 낯설까\r\n"
			+ "난 한국말까지 서툴러\r\n"
			+ "번역기도 전혀 도움 안 돼\r\n"
			...
			+ "가르쳐줘 오늘 밤\r\n"
			+ "가나다라마바사"));
	list.add(new Music("이제 나만 믿어요","임영웅","https://cdnimg.melon.co.kr/cm2/album/images/104/12/319/10412319_20200403103006_500.jpg/melon/resize/120/quality/80/optimize","무얼 믿은 걸까 부족했던 내게서\r\n"
			...
			+ "그대는 걱정 말아요\r\n"
			+ "이제 나만 믿어요"));
	list.add(new Music("무지개","임영웅","https://cdnimg.melon.co.kr/cm2/album/images/109/23/444/10923444_20220502140600_500.jpg/melon/resize/120/quality/80/optimize","오늘 하루 어땠었나요\r\n"
			+ "많이 힘들었나요\r\n"
			+ "쉬지 않고 달려왔던 길에서\r\n"
			+ "나와 함께 쉬어가요\r\n"
			+ "그냥 아무런 준비도 없이\r\n"
			...
			+ "Du Du Du Du\r\n"
			+ "지금 떠나요"));
	list.add(new Music("HOT","세븐틴","https://cdnimg.melon.co.kr/cm2/album/images/109/22/231/10922231_20220527120653_500.jpg/melon/resize/120/quality/80/optimize","모두 우릴 쳐다봐 (봐)\r\n"
			...
			+ "태양을 향해 불붙여라\r\n"
			+ "뜨거워 이 노래 Everybody 떼창"));
	list.add(new Music("아버지","임영웅","https://cdnimg.melon.co.kr/cm2/album/images/109/23/444/10923444_20220502140600_500.jpg/melon/resize/120/quality/80/optimize","하얀 머리 뽑아 달라며\r\n"
			+ "한 개 백 원이라던\r\n"
			+ "그 시절 다 지나가고\r\n"
			+ "이젠 흰 눈만 남았네\r\n"
			+ "그렇게도 힘이 드냐며\r\n"
			...
			+ "사랑하는 내 아버지\r\n"
			+ "사랑해요 내 아버지"));
	list.add(new Music("ZOOM","제시 (Jessi)","https://cdnimg.melon.co.kr/cm2/album/images/109/18/269/10918269_20220413101153_500.jpg/melon/resize/120/quality/80/optimize","Lights Camera Action\r\n"
			+ "\r\n"
	...
	list.add(new Music("신호등","이무진","https://cdnimg.melon.co.kr/cm2/album/images/106/07/796/10607796_20210513201807_500.jpg/melon/resize/120/quality/80/optimize","이제야 목적지를 정했지만\r\n"
			...
			+ "느린지도 모르겠어\r\n"
			+ "그저 눈앞이 샛노랄 뿐이야"));
	list.add(new Music("다정히 내 이름을 부르면","경서예지,전건호","https://cdnimg.melon.co.kr/cm2/album/images/106/10/525/10610525_20210518143433_500.jpg/melon/resize/120/quality/80/optimize","끝없이 별빛이 내리던 밤\r\n"
			+ "기분 좋은 바람이\r\n"
			+ "두 빰을 스치고\r\n"
			+ "새벽 바다 한곳을 보는\r\n"
			+ "아름다운 너와 나\r\n"
			...
			+ "널 사랑한다고\r\n"
			+ "말할게"));
	list.add(new Music("손이 참 곱던 그대","임영웅","https://cdnimg.melon.co.kr/cm2/album/images/109/23/444/10923444_20220502140600_500.jpg/melon/resize/120/quality/80/optimize","손이 참 곱던 그대 어느새 이렇게\r\n"
			+ "내 맘 깊숙이 스며들었나요\r\n"
			+ "나 그대의 그 미소에\r\n"
			+ "맘이 떨려 한순간\r\n"
			+ "그대 때문에 음흠 그대여 음흠\r\n"
			...
			+ "내 맘 깊숙이\r\n"
			+ "나 그대의 그 미소에 음흠"));
	list.add(new Music("INVU","태연 (TAEYEON)","https://cdnimg.melon.co.kr/cm2/album/images/108/63/559/10863559_20220214160739_500.jpg/melon/resize/120/quality/80/optimize","Falling in love\r\n"
			+ "너에겐 난 Option\r\n"
			+ "시작부터 다른 너와 나\r\n"
			+ "깨지는 Heart\r\n"
			+ "빗나간 네 Mention\r\n"
			...
			+ "\r\n"
			+ "I N V U"));
	list.add(new Music("ELEVEN","IVE (아이브)","https://cdnimg.melon.co.kr/cm2/album/images/107/98/794/10798794_20211201113915_500.jpg/melon/resize/120/quality/80/optimize","따분한 나의 눈빛이\r\n"
			+ "무표정했던 얼굴이\r\n"
			+ "널 보며 빛나고 있어\r\n"
			+ "널 담은 눈동자는 odd\r\n"
			+ "\r\n"
